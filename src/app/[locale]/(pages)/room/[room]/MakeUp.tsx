    ...
    <div className="pt-[85px] px-4 md:pt-0 ">
      ...
      >
        ...
        <div className={`flex flex-col gap-8 md:w-[65%] md:gap-32 p-4`}>
          ...
          <Link
            href={`/reservation`}
            className={`px-4 py-3 text-white bg-[#522c22] w-fit rounded-2xl flex hover:scale-[1.05] transition m-auto md:m-0 md:mx-auto text-[20px] ${unbounded.className} font-[300]`}
          >
