...
const PageContent = ({ roomSlug, galleryImages, equipmentImages }: Props) => {
    ...
    const roomEnum = getRoomEnum(roomSlug as string);

    return (
        <div className={`pt-[80px] md:pt-0 px-4`}>
            {roomSlug && <Image src={roomEnum.HEADER_IMAGE} alt={'main_photo'} width={980} height={317} className={`rounded-2xl mb-8`} />}
