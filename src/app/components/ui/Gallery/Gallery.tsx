    ...
    <div key={showImagesCount}>
      ...
      {galleryImages.length > showImagesCount && (
        <button
          ...
          className={`m-auto block text-white py-3 px-6 rounded-[12px] bg-[#522c22] backdrop-blur-[5px] hover:scale-[1.05] transition text-[20px] tracking-[1px] ${unbounded.className} font-[300]`}
        >
          {t("show_more")}
        </button>
      )}
