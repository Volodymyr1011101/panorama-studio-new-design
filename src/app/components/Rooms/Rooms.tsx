  ...
  return (
    <>
      ...
      <div className={styles.rooms}>
        {rooms.map((room) => (
          <div
            ...
            key={room.image.src + room.image.width}
          >
      ...
      <div className={``}>
        <Link
          href={`/reservation`}
          className={`px-4 py-3 text-white bg-[#522c22] w-fit rounded-2xl flex mx-auto hover:scale-[1.05] transition text-[25px] tracking-[1px] ${unbounded.className} font-[300]`}
        >
          {t(`reservation`)}
        </Link>
      </div>
